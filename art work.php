...
<body class="host_version"> 
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>ART Work<span class="m_1">.</span></h1>
		</div>
	</div>
        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <p class="lead">Humanity is just like the design of ART.</p>
                </div>
            </div><!-- end title -->
			...
			?>
				<div class="col-sm-3"><img src="dbimages/<?= $row['image'] ?>" alt="" class="img-fluid"><div style="text-align:center;font-weight:600;"><?= $row['description'] ?></div></div>
