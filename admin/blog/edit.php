<?php 
   ...
   include("../connection.php");
    ...
    $id = $_GET['id'];
    $showdata = mysqli_query($connect, "SELECT * from `blog` where `id` = $id");
    $row = mysqli_fetch_assoc($showdata);
       ...
       if(isset($_POST['update'])){
        ...
        $tag = $_POST["tag"];
          ...
          $sql = "UPDATE `blog` SET `title`='$title',`content`='$content',`tag`='$tag' WHERE `id` = $updateid";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
              ...
              <h3 class="fs-4 mb-3" style="margin-top: 20px;">Update Blog</h3>
                      ...
                      <div class="col-sm-12">
                        ...
                        <div class="form-group">
                          ...
                          <label>Blog Content</label>
                            <textarea id="editor" class="form-control ckeditor" name="content" rows="6" ><?= $row['content']?></textarea>
                          </div>
                        </div>
