<?php
   ...
   if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $delete = mysqli_query($connect,"DELETE from `testimonial` where `id`= '$id'");
   }
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
               ...
               <a href="add.php"> <button type="submit" class="btn">Add new Testimoni</button></a>
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">testimonies</h3>
                    <div class="col">
