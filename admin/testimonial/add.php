<?php
   ...
   include("../connection.php");
    ...
    move_uploaded_file($tempimgname,"../../dbimages/$image" );
            ...
            $sql = "INSERT INTO `testimonial` (`name`,`quote`,`image`,`testimoni`,`status`) VALUES ('$name','$quote','$image','$testimoni','$status')";
                      ...
                      <div class="col-sm-12">
                       ...
                       <div class="form-group">
                          ...
                          <label>Testimonial</label>
                            <textarea class="form-control ckeditor" name="testimoni" rows="6" required></textarea>
                          </div>
