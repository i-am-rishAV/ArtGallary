<?php
   ...
   $sql = "SELECT * from `rangoli` ";
   $rangoli = $connect->query($sql);

   if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $delete = mysqli_query($connect,"DELETE from `rangoli` where `id`= '$id'");
   }
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
               ...
               <a href="add.php"> <button type="submit" class="btn">Add new </button></a>
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Rangoli</h3>
                    <div class="col">
                    <div class= "table-responsive">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <?php 
                            while($row = mysqli_fetch_assoc($rangoli)){
                            ?>
                                <tr>
                                    <th scope="row"><?= $row['id']?></th>
                                    <td><img src="../../../dbimages/<?= $row['image']?>" alt="" style="width: 90px; height: 80px;"></td>
