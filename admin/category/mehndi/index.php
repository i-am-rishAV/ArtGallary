<?php
   ...
   $sql = "SELECT * from `mehndi` ";
   $mehndi = $connect->query($sql);

   if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $delete = mysqli_query($connect,"DELETE from `mehndi` where `id`= '$id'");
   }
                ...
                <div class="row my-5">
                    ...
                    <div class= "table-responsive">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <?php 
                            while($row = mysqli_fetch_assoc($mehndi)){
                            ?>
                                <tr>
