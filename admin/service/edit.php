<?php
   ...
   include("../connection.php");
    ...
    $id = $_GET['id'];
    $showdata = mysqli_query($connect, "SELECT * from `service` where `id` = $id");
    $row = mysqli_fetch_assoc($showdata);
       ...
       if(isset($_POST['update'])){
        ...
        $des5 = $_POST["des5"];
          ...
          $sql = "UPDATE `service` SET `title`='$title',
                                       `price`='$price',
                                       `info`='$info',
                                       `des1`='$des1',
                                       `des2`='$des2',
                    ...
                    <div class="form">
                      ...
                      <div class="col-sm-12">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-12">
                          <label>Post info</label><span>*</span>
                            <textarea class="form-control ckeditor" name="info" rows="6" required><?= $row['info']?></textarea>
                          </div>
                        </div>

                        <div class="col-sm-12">
                            <label>Description 1</label><span>*</span>
                                <input type="text" class="form-control" name="des1" value="<?= $row['des1']?>" required>
                              </div>
                        <div class="col-sm-12">
                            <label>Description 2</label><span>*</span>
                                <input type="text" class="form-control" name="des2" value="<?= $row['des2']?>" required>
                              </div>
                        <div class="col-sm-12">
                            <label>Description 3</label>
                                <input type="text" class="form-control" name="des3" value="<?= $row['des3']?>">
                              </div>
                        <div class="col-sm-12">
                            <label>Description 4</label>
                                <input type="text" class="form-control" name="des4" value="<?= $row['des4']?>">
                              </div>
                        <div class="col-sm-12">
                            <label>Description 5</label>
                                <input type="text" class="form-control" name="des5" value="<?= $row['des5']?>">
                              </div>
<!--  -->
