...
include ("../session.php");
   ...
   $service = $connect->query($sql);

   if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $delete = mysqli_query($connect,"DELETE from `service` where `id`= '$id'");
   }
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><i
                    class="fas fa-user-secret me-2"></i>Art Gallary</div>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <a href="add.php"> <button type="submit" class="btn">Add new Service</button></a>
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Services</h3>
                    <div class="col">
                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"> Des 1  </th>
                                    <th scope="col"> Des 2  </th>
                                    <th scope="col"> Des 3  </th>
                                    <th scope="col"> Des 4  </th>
                                    <th scope="col"> Des 5  </th>
